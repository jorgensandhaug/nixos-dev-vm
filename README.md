...
> "Set up a NixOS dev VM for me following the instructions at https://github.com/jorgensandhaug/nixos-dev-vm/blob/main/AGENT.md"
...
2. SSH in and run the bootstrap:
   ```bash
   ssh azureuser@<vm-ip> "curl -fsSL https://raw.githubusercontent.com/jorgensandhaug/nixos-dev-vm/main/bootstrap.sh | \
